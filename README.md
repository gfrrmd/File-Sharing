...
Ambil dari [Telegram Developer](https://my.telegram.org/auth).
...
- Jadikan bot sebagai admin dan izinkan semua akses
- Ambil ID channel dari [@userinfobot](https://t.me/userinfobot)
- Masukkan ke `DB_CHANNEL`

## PENTING!

Jika setelah deploy dan upload file gagal, jadikan bot sebagai admin di Database secara ulang.
